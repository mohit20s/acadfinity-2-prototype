...
import { LayoutDashboard, Database, BookOpen, ShoppingBag, Library, Settings, X } from "lucide-react";
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "ERP", href: "/erp", icon: Database, show: !isB2C }, // HIDDEN FOR B2C
  ...
  return (
    <>
      {isMobileSidebarOpen && <div className="fixed inset-0 bg-slate-900/50 z-40 md:hidden" onClick={closeMobileSidebar} />}
      ...
      >
        ...
        <div className="p-4 border-t border-slate-200">
          <Link href="/settings" className="flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-slate-900">
